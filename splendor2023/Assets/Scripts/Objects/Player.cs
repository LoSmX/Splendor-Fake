...
public class Player : MonoBehaviour
{
    ...
    public CoinCollection coinsBalance = new CoinCollection();         // Structure holding information about the possessed coins
    public CoinCollection cardBalance = new CoinCollection();          // Structure holding information about the possessed cards
    ...
    {
        chip.amount--;
        CoinCollection coins = new CoinCollection(chip);
        coinsBalance += coins;
    ...
    public void onClickEvent(object data)
    {
        ...
        if (data is Card)
        {
            ...
            else if(turnActionCounter == 2 && coinsTaken.Contains(Coins.Color.gold) && !(data is  Nobel))
            {
